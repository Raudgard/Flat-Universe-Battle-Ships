...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    public class Image_copy_test: MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        /// <summary>
        ...
        public FillMethod fillMethod { get { return m_FillMethod; } set { 
                ...
                {
                    m_FillMethod = value;
                    SetVerticesDirty(); m_FillOrigin = 0; } } }
        ...
        static List<Image_copy_test> m_TrackedTexturelessImages = new List<Image_copy_test>();
        ...
        private static void TrackImage(Image_copy_test g)
        {
            if (!s_Initialized)
            {
        ...
        private static void UnTrackImage(Image_copy_test g)
        {
